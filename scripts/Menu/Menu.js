...
const activateMenu = () => {
  // setMenuContainer(constants.elements.header.navigation.wrapper())
  createBurger(constants.elements.header.wrapper.logo());
  openMenu();
  // renderLevels(constants.elements.header.navigation.levels);
  // showSubMenu();
}
